...
export class AppService {
  ...
  public addToCart(menuItem:MenuItem, component:any){   
    if(!this.Data.cartList.find(item=>item.id == menuItem.id)){
      ...
      if(component){
        ...
        this.snackBar.open('The menu item "' + menuItem.itemName + '" has been added to cart.', '×', {
  ...
  public addToFavorites(menuItem:MenuItem){
    ...
    if(this.Data.favorites.find(item=>item.id == menuItem.id)){ 
      message = 'The menu item "' + menuItem.itemName + '" already added to favorites.'; 
      status = 'error';    
    } 
    else{
      this.Data.favorites.push(menuItem);
      message = 'The menu item "' + menuItem.itemName + '" has been added to favorites.'; 
      status = 'success';  
    } 
